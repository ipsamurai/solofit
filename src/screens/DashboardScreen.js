				...
				{vitals ? (
					...
					<Card>
						<Text style={styles.emptyText}>
							No vitals data yet. Run a scan to start.
						</Text>
					</Card>
				)}
								...
								{todayMeals.map((meal, i) => (
									<View key={i} style={styles.mealRow}>
										...
										<Text style={styles.mealCal}>
											{meal.primary?.calories} cal
										</Text>
									</View>
								))}
								<View style={styles.macroRow}>
									<Text style={styles.macroText}>
										Total: {fitnessPlan.calories} cal
									</Text>
									<Text style={styles.macroText}>
										Water: {fitnessPlan.hydration_liters}L
									</Text>
								</View>
							</Card>
						</TouchableOpacity>
...
const styles = StyleSheet.create({
	...
	greeting: { ...FONTS.h2, fontSize: 34, lineHeight: 36 },
