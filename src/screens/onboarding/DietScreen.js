  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>We'll strictly respect these in every meal plan</Text>

        <Text style={styles.label}>Diet Type</Text>
        <ChipSelector options={DIET_TYPES} selected={dietType} onToggle={setDietType} />

        <Text style={styles.label}>Allergies & Restrictions</Text>
        <Text style={styles.warning}>These will NEVER appear in your meal plans</Text>
        <ChipSelector options={COMMON_ALLERGIES} selected={allergies} onToggle={setAllergies} multi />
