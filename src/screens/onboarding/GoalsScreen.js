  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <ChipSelector options={FITNESS_GOALS} selected={goals} onToggle={setGoals} multi />
        ...
        {ACTIVITY_LEVELS.map((level) => (
          ...
          >
            <Text
              style={[styles.optionLabel, activityLevel === level.id && styles.optionLabelActive]}
        ...
        <View style={styles.buttonContainer}>
          <GradientButton title="Continue" onPress={handleNext} disabled={!canContinue} />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  optionLabel: { ...FONTS.body, fontWeight: '600' },
